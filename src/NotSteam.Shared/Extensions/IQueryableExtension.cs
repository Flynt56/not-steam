...
namespace NotSteam.Shared.Extensions
{
    public static class IQueryableExtension
    {
        ...
        public static IQueryable<T> ApplyPagination<T>(this IQueryable<T> query, AbstractPagingRequest<T> pagingRequest)
        {
            ...
            var numberOfElementsToSkip = (pagingRequest.Page.Value - 1) * pagingRequest.PageSize.Value;
            ...
            Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null)
        {
            ...
            {
                var pageCount = (int)Math.Ceiling(totalResults / (double)pagingRequest.PageSize);
