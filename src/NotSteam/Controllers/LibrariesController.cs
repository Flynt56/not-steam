...
namespace NotSteam.Controllers
{
    ...
    public class LibrariesController : ControllerBase
    {
        ...
        public LibrariesController(NotSteamContext context)
        {
            ...
            {
                _context.Libraries.Add(new Library { UserId = 1, GameId = 1, TotalPlayTimeHours = 321 });
                _context.Libraries.Add(new Library { UserId = 2, GameId = 1, TotalPlayTimeHours = 40 });
                _context.Libraries.Add(new Library { UserId = 1, GameId = 2, TotalPlayTimeHours = 10 });
