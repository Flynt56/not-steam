...
namespace NotSteam.Extensions
{
    ...
    {
        public static void ManyToManyRelationshipsSetup(this ModelBuilder modelBuilder)
        {
        ...
        private static void Review(ModelBuilder modelBuilder)
        {
        ...
        private static void Library(ModelBuilder modelBuilder)
        {
        ...
        private static void GameTag(ModelBuilder modelBuilder)
        {
        ...
        private static void Game(ModelBuilder modelBuilder)
        {
        ...
        private static void Tag(ModelBuilder modelBuilder)
        {
        ...
        private static void Company(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Company>().HasData(
                ...
                new
                {
                    ...
                    Description = "We make great action-adventure," +
                    " role-playing games!",
